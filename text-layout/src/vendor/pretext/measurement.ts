...
export type MeasureContextLike = {
  font: string
...
type MeasurementContextFactory = () => MeasureContextLike

let measureContext: MeasureContextLike | null = null
let measurementContextFactory: MeasurementContextFactory | null = null
...
export function registerMeasurementContextFactory(factory: MeasurementContextFactory | null): void {
  measurementContextFactory = factory
  measureContext = null
}
...
export function getMeasureContext(): MeasureContextLike {
  ...
  if (measurementContextFactory !== null) {
    measureContext = measurementContextFactory()
