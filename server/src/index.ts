...
import v1InterviewRoutes from './routes/v1/interview.js';
import v1ConsoleRoutes from './routes/v1/console.js';
...
app.get(['/api/health', '/api/v1/health'], publicRateLimit, (_req, res) => {
  res.json({ status: 'ok' });
});
...
app.use('/api/v1/projects/:projectId', v1InterviewRoutes);
app.use('/api/v1/projects/:projectId', v1ConsoleRoutes);
